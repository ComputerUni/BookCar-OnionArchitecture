...
{
    public class GetCarCountByTransmissionIsAutoQueryHandler(IStatisticsRepository _repository) : IRequestHandler<GetCarCountByTransmissionIsAutoQuery, GetCarCountByTransmissionIsAutoQueryResult>
    {
